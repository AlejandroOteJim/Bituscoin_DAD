...
public class MinerVerticle extends AbstractVerticle {
    ...
    private void mineBlockPoW(Block block) {
        // Dificultad hardcodeada a 4 para el ejemplo (o blockchain.getDifficulty())
        int difficulty = 4;
        String target = new String(new char[difficulty]).replace('\0', '0');

        // Bucle hasta encontrar un hash que empiece por "0000..."
