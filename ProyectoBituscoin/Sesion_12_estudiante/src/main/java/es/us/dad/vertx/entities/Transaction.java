...
public class Transaction {
    ...
    public String calculateHash() {
        String dataToHash = sender + receiver + Long.toString(amount) + Long.toString(timestamp) + signature;
        return applySha256(dataToHash);
    }

    public boolean verifySignature() {
        // TODO: Implementar la verificación de la firma usando la clave pública del sender y el contenido de la transacción.
        // Esto implicaría:
        // 1. Obtener la clave pública del sender (puede ser un String que se convierta a PublicKey).
        // 2. Verificar que la firma es válida para el contenido de la transacción (puedes usar el método verifyECDSASig de SecurityUtils).
        // 3. Devolver true si la firma es válida, false en caso contrario.
        return true; // Placeholder, debes implementar la lógica real aquí.
    }
